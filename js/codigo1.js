$(document).ready(() => {
    ...
    function AparecerAlerta() {
      setTimeout(() => {
        ...
        contadorEnemigo = milisegundos(date) + getRandomInt(0, 1500);
  ...
  win=()=>{
    ...
    prota.innerHTML=`<img src="./jpgs/protaw1.png">`;
    enemigo.innerHTML=`<img src="./jpgs/enemyd.png">`;
  ...
  lost=()=>{
    prota.innerHTML=`<img src="./jpgs/protad1.png">`;
    enemigo.innerHTML=`<img src="./jpgs/enemyw.png">`;
    ...
    function mostrarVentana(){
      ...
      let footer = `
      <button type="button" class="btn btn-primary" onclick="window.location='nivel1.html'">Repetir</button>   
